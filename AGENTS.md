...
- **Post-Script Verification**: Never rely solely on automated transformation scripts for data cleaning or restructuring. ALWAYS inspect sample files using `view_file` after script execution to ensure no header corruption or unexpected pattern matching occurred.
